...
**Цель:** Проверить все endpoints, типизацию
...
-   [ ] entities/ создан со всеми сущностями
-   [ ] Типы перенесены из shared в entities
-   [ ] Базовые UI компоненты в entities/\*/ui/

### API:

-   [ ] RTK Query настроен
-   [ ] Все API calls через RTK Query
-   [ ] 80% ошибок в API routes
-   [ ] CSRF protection

### UI:

-   [ ] Скелетоны для ВСЕХ async данных
-   [ ] Комментарии с маленькой буквы
-   [ ] next/image везде
-   [ ] Responsive (sm/md/lg/xl)
-   [ ] a11y (aria-label, alt, semantic HTML)
...
1. ✅ Читаю ARCHITECTURE_GUIDE.md
2. ✅ Создаю этот план
3. ⏳ Спрашиваю разрешение начать Этап 2
4. Создаю entities/ структуру
5. Переношу типы и UI
6. RTK Query setup
7. Скелетоны + комментарии
8. Error handling
9. Performance
10. SEO
11. Final testing
...
**ПРИОРИТЕТ:** Критический (проект не соответствует стандартам)
**НАЧИНАЕМ?** Жду команды!
