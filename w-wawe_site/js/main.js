...
document.addEventListener('DOMContentLoaded', (e) => {
  document.getElementById ('search-form__open').addEventListener('click', (e)=> {
    document.getElementById ('search-form').classList.toggle('search-form__show')
  })
})

document.addEventListener('DOMContentLoaded', (e) => {
  document.getElementById ('search-form__open').addEventListener('click', (e)=> {
    document.getElementById ('search-form__open').classList.toggle('search-btn-hidden')
    document.querySelector(".header-top").classList.remove("position")
  })
})
...
document.addEventListener("DOMContentLoaded", function(){
 ...
 document.addEventListener("DOMContentLoaded", (e)=>{
    document.getElementById("podcasts__btn").addEventListener("click", (e) =>{
        ...
        document.getElementById("podcasts__btn").textContent = "Скрыть"

        if(document.getElementById("podcasts__btn").textContent == "Скрыть"){
            document.getElementById("podcasts__btn").textContent = "Ещё подкасты"
        }
    })
})
